...
const App = () => {
  ...
  const contractAddress = "0xC6AF0b3c5679374E9C5cC20E9ebA8DFA1b3B31C0";
  ...
  const wave = async () => {
    ...
    try {
      ...
      if (ethereum) {
        ...
        alert(
          "Ethereum object doesn't exist! Please setup your Ethereum wallet, such as MetaMask to continue!"
        );
      }
    } catch (error) {
      console.log(error);
  ...
  return (
    <div className="mainContainer">
      <div className="dataContainer">
        ...
        <div className="bio">
          I am Nandeesh. I am learning Web3. Connect your Ethereum wallet and
          wave at me!
        </div>
